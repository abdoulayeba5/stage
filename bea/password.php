...
<body>
  ...
  <div class="full-page">
    ...
    <div class="form-box">
      ...
      <form id='login' class='input-group-login' method="POST" action="verify.php">
        <input type='text' class='input-field' placeholder='Code' required name="sent_code"><br><br><br><br><br>


        <button type='submit' class='submit-btn' name="verify_button">verifier</button>
      </form>
      </form>
