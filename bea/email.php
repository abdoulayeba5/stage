...
<body>
  ...
  <div class="full-page">
    ...
    <div class="form-box">
      ...
      <form id='login' class='input-group-login' method="POST" action="send.php">
        <input type='text' class='input-field' placeholder='Email' required name="forgoten_email"><br><br><br><br><br>


        <button type='submit' class='submit-btn' name="send_button" value="connecter">send</button>
      </form>
      </form>
